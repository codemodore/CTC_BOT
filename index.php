...
$botToken = "485059092:AAFTWGi3HULLFHJkTN0D9b7sMQyJnlx45BY";
...
{
	$mensaje = "Si requieres soporte tecnico mandanos un mensaje a:%0Asupport@comertradecorp.com";
	enviarmensaje($chatId,$mensaje);
}
...
{
	$message = "Hola, soy <b>El Bot de Carprotector</b> y te puedo indicar tu /id%0ALo necesitas para que te pueda enviar alertas.%0ASi requieres asistencia solicita /soporte";
